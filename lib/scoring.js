 ...
 * velocity 30 / volume spike 25 / trending presence 20 / sentiment 10.
 * Max achievable score is 85, not 100 - the point value of the other
 * categories was deliberately left unchanged rather than redistributing the
 * insider category's 15 points elsewhere, so the entry/sizing thresholds
 * (40/55/70) keep the same meaning they were already tuned against.
 */
function scoreToken(token) {
  ...
  return { score: Math.max(0, Math.min(85, score)), reasons, volumeRatio };
}
