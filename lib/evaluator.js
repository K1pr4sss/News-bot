...
async function evaluateCandidate(token, { trendingPool = false } = {}) {
  ...
  enriched.positiveRatio = redditSignal.positiveRatio; // Alerts/Telegram are too sparse for a meaningful sentiment read - Reddit stays the only sentiment source
